...
export function PrintAllCardsDialog({ animals, campaignYear }: PrintAllCardsDialogProps) {
  ...
  const syncFromLocalStorage = () => {
    if (typeof window !== 'undefined') {
      ...
      setAutoDistrict(localStorage.getItem('kurban_card_auto_district') !== 'false')
    }
  }
            ...
            <div className="grid gap-1.5">
              ...
              <div className="flex items-center gap-2 mt-1 select-none">
                <input
                  ...
                  className="w-4 h-4 text-emerald-600 border-slate-350 rounded focus:ring-emerald-500 accent-emerald-600 cursor-pointer"
                />
                <Label htmlFor="global_auto_district" className="text-[11px] font-bold text-slate-650 cursor-pointer">
